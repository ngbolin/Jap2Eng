...
def train(args: Dict):
    ...
    """
    train_data_src = read_corpus(args['--train-src'], source='src', vocab_size=50000)       # EDIT: NEW VOCAB SIZE
    train_data_tgt = read_corpus(args['--train-tgt'], source='tgt', vocab_size=50000)
...
def decode(args: Dict[str, str]):
    ...
    test_data_src = read_corpus(args['TEST_SOURCE_FILE'], source='src', vocab_size=8000)
    if args['TEST_TARGET_FILE']:
        print("load test target sentences from [{}]".format(args['TEST_TARGET_FILE']), file=sys.stderr)
        test_data_tgt = read_corpus(args['TEST_TARGET_FILE'], source='tgt', vocab_size=8000)
