...
if __name__ == '__main__':
    ...
    src_sents = get_vocab_list(args['--train-src'], source='src', vocab_size=30000)          # EDIT: NEW VOCAB SIZE
    tgt_sents = get_vocab_list(args['--train-tgt'], source='tgt', vocab_size=30000)
