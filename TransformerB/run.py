...
def train(args: Dict):
    ...
    dev_data_src = read_corpus(args['--dev-src'], source='src', vocab_size=5000)
    dev_data_tgt = read_corpus(args['--dev-tgt'], source='tgt', vocab_size=5000)
...
def decode(args: Dict[str, str]):
    ...
    test_data_src = read_corpus(args['TEST_SOURCE_FILE'], source='src', vocab_size=15000)
    if args['TEST_TARGET_FILE']:
        print("load test target sentences from [{}]".format(args['TEST_TARGET_FILE']), file=sys.stderr)
        test_data_tgt = read_corpus(args['TEST_TARGET_FILE'], source='tgt', vocab_size=15000)
