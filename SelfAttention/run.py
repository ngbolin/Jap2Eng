...
def train(args: Dict):
    ...
    """
    train_data_src = read_corpus(args['--train-src'], source='src', vocab_size=30000)       # EDIT: NEW VOCAB SIZE
    train_data_tgt = read_corpus(args['--train-tgt'], source='tgt', vocab_size=30000)

    dev_data_src = read_corpus(args['--dev-src'], source='src', vocab_size=8000)
    dev_data_tgt = read_corpus(args['--dev-tgt'], source='tgt', vocab_size=8000)
